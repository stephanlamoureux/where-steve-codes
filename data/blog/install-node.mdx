...
draft: false
lastmod: '2022-10-11'
tags: ['node', 'nvm', 'npm', 'javascript']
summary: 'Installing Node using NVM and basic commands.'
---

![Node.js Logo](https://res.cloudinary.com/practicaldev/image/fetch/s--Nejuqios--/c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/a2u61t1cjaks3ugnxqjl.jpg)
...
Check out the official [NPM](https://docs.npmjs.com/), [NVM](https://github.com/nvm-sh/nvm), and [Node.js](https://nodejs.org/en/docs/) docs for more in-depth guides.
