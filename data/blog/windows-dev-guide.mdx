---
title: 'The Complete Windows Web Dev Setup Guide'
date: '2022-05-28'
lastmod: '2022-10-10'
summary: 'A complete web developer setup guide for Windows users.'
layout: PostSimple
draft: false
tags: ['windows', 'wsl', 'zsh', 'chocolatey', 'npm', git, 'github', 'ruby', 'pyhton']
---

![Windows Logo](/static/images/blogs/windows.jpg)
