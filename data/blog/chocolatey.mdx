...
summary: 'Installing and using the Chocolatey package manager for Windows.'
---

![Chocolate](https://res.cloudinary.com/practicaldev/image/fetch/s--CHTFqoNO--/c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/4kkaazjs2qikjr7gl2bd.jpg)
